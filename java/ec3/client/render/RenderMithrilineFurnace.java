...
public class RenderMithrilineFurnace extends TileEntitySpecialRenderer
{
    public static final ResourceLocation textures = new ResourceLocation("essentialcraft:textures/special/models/mithrilineFurnace.png");
    public static final IModelCustom model = AdvancedModelLoader.loadModel(new ResourceLocation("essentialcraft:textures/special/models/MithrilineFurnace.obj"));

    public RenderMithrilineFurnace()
    {
    }
