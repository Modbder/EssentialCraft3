...
public class RenderPoisonFume extends RenderLiving
{
     ...
     */
    protected int shouldRenderPass(EntityPoisonFume p_77032_1_, int p_77032_2_, float p_77032_3_)
    {
        return -1;
    }
    ...
    protected void renderEquippedItems(EntityPoisonFume p_77029_1_, float p_77029_2_)
    {
    ...
    {
        this.doRender((EntityPoisonFume)p_76986_1_, p_76986_2_, p_76986_4_, p_76986_6_, p_76986_8_, p_76986_9_);
    }
    ...
    {
        this.preRenderCallback((EntityPoisonFume)p_77041_1_, p_77041_2_);
    }
    ...
    {
        return this.shouldRenderPass((EntityPoisonFume)p_77032_1_, p_77032_2_, p_77032_3_);
    }

    protected void renderEquippedItems(EntityLivingBase p_77029_1_, float p_77029_2_)
    {
        this.renderEquippedItems((EntityPoisonFume)p_77029_1_, p_77029_2_);
    }
    ...
    {
        return this.getEntityTexture((EntityPoisonFume)p_110775_1_);
    }
