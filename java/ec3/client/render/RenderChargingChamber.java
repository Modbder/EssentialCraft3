...
public class RenderChargingChamber extends TileEntitySpecialRenderer
{
	public static final ResourceLocation textures = new ResourceLocation("essentialcraft:textures/special/models/chargingChamber.png");
    public static final IModelCustom model = AdvancedModelLoader.loadModel(new ResourceLocation("essentialcraft:textures/special/models/ChargingChamber.obj"));
    ...
    public void doRender(TileEntity p_76986_1_, double p_76986_2_, double p_76986_4_, double p_76986_6_, float p_76986_8_, float p_76986_9_)
    {
        ...
        TileChargingChamber tile = (TileChargingChamber) p_76986_1_;
    	...
    	GL11.glPushMatrix(); 
    	MiscUtils.renderItemStack_Full(tile.getStackInSlot(1),p_76986_1_.xCoord+0.5D,p_76986_1_.yCoord+10D , p_76986_1_.zCoord+0.5D, p_76986_2_, p_76986_4_, p_76986_6_, rotation,0F, 1, 1, 1, 0.5F, 0.65F+((float)upperIndex/500F),0.5F);
    	GL11.glPopMatrix();
