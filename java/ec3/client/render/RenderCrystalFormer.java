...
{
	public static final ResourceLocation textures = new ResourceLocation("essentialcraft:textures/special/models/crystalFormer.png");
    public static final IModelCustom model = AdvancedModelLoader.loadModel(new ResourceLocation("essentialcraft:textures/special/models/CrystalFormer.obj"));
    ...
    public void doRender(TileEntity p_76986_1_, double p_76986_2_, double p_76986_4_, double p_76986_6_, float p_76986_8_, float p_76986_9_)
    {
        ...
        GL11.glPushMatrix();
        GL11.glTranslatef((float)p_76986_2_+0.8F, (float)p_76986_4_+1.1F, (float)p_76986_6_+0.5F);
        ...
        GL11.glPushMatrix();
        GL11.glTranslatef((float)p_76986_2_+0.2F, (float)p_76986_4_+1.1F, (float)p_76986_6_+0.5F);
        GL11.glScalef(scale, scale, scale);
        GL11.glRotatef(180, 1, 0, 0);
        this.bindTexture(RenderElementalCrystal.neutral);
        RenderElementalCrystal.crystal.renderModel(0.0625F);;
        ...
        GL11.glPushMatrix();
        GL11.glTranslatef((float)p_76986_2_+0.5F, (float)p_76986_4_+1.1F, (float)p_76986_6_+0.8F);
        GL11.glScalef(scale, scale, scale);
        GL11.glRotatef(180, 1, 0, 0);
        this.bindTexture(RenderElementalCrystal.neutral);
        RenderElementalCrystal.crystal.renderModel(0.0625F);;
        ...
        GL11.glPushMatrix();
        GL11.glTranslatef((float)p_76986_2_+0.5F, (float)p_76986_4_+1.1F, (float)p_76986_6_+0.2F);
        GL11.glScalef(scale, scale, scale);
        GL11.glRotatef(180, 1, 0, 0);
        this.bindTexture(RenderElementalCrystal.neutral);
        RenderElementalCrystal.crystal.renderModel(0.0625F);;
