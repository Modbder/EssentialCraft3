...
public class RenderWindRune extends TileEntitySpecialRenderer
{
    public static final ResourceLocation rune = new ResourceLocation("essentialcraft:textures/special/models/windRune.png");
    ...
    public void doRender(TileEntity tile, double p_76986_2_, double p_76986_4_, double p_76986_6_, float p_76986_8_, float p_76986_9_)
    {
    	...
    	TileWindRune p = (TileWindRune) tile;
