...
public class GuiMRUGenerated extends GuiTextField{
	...
	public void drawText(int posX, int posY) {
		...
		{
			Minecraft.getMinecraft().fontRenderer.drawStringWithShadow("10UBMRU > 1MRU", posX+2, posY+5, 0xffffff);
		}
		...
		if(tileValue.equals("naturalFurnace"))
		{
			if(tile instanceof TileFlowerBurner)
			{
				...
				Minecraft.getMinecraft().fontRenderer.drawStringWithShadow((int)10+" MRU/t", posX+2, posY+5, 0xffffff);
		...
		{
			Minecraft.getMinecraft().fontRenderer.drawStringWithShadow((int)500+" MRU/hit", posX+2, posY+5, 0xffffff);
		}
		if(tileValue.equals("sunray"))
		{
			Minecraft.getMinecraft().fontRenderer.drawStringWithShadow((int)500+" MRU/t", posX+2, posY+5, 0xffffff);
		}
