...
public class GuiFlowerBurner extends GuiCommon{

	public GuiFlowerBurner(Container c, TileEntity tile) {
		super(c,tile);
		...
		this.elementList.add(new GuiMRUGenerated(25, 40,tile,"naturalFurnace"));
	}
