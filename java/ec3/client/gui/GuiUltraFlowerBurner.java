...
public class GuiUltraFlowerBurner extends GuiCommon{

	public GuiUltraFlowerBurner(Container c, TileEntity tile) {
		super(c,tile);
		...
		this.elementList.add(new GuiMRUGenerated(25, 40,tile,"ultraNaturalFurnace"));
	}
