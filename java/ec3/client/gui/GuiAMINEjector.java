...
public class GuiAMINEjector extends GuiCommon{

	public GuiAMINEjector(Container c, TileEntity tile) {
		super(c,tile);
	}
    ...
    public void drawScreen(int p_73863_1_, int p_73863_2_, float p_73863_3_)
    {
	    ...
	    int k = (this.width - this.xSize) / 2;
	    int l = (this.height - this.ySize) / 2;
	    this.fontRendererObj.drawString(((TileAMINEjector)this.genericTile).slotnum+"", k+85, l+40, 0x000000);
	    TileAMINEjector e = (TileAMINEjector) this.genericTile;
