...
public class GuiSunRayAbsorber extends GuiCommon{

	public GuiSunRayAbsorber(Container c, TileEntity tile) {
		super(c,tile);
		...
		this.elementList.add(new GuiMRUGenerated(25, 40,tile,"sunray"));
	}
