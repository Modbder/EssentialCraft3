...
public class BlockMINInjector extends BlockContainer{

	public BlockMINInjector(Material p_i45394_1_) {
		super(p_i45394_1_);
	}
	...
	public TileEntity createNewTileEntity(World p_149915_1_, int metadata) {
		...
		return metadata < 6 ? new TileMINInjector() : new TileAMINInjector();
	}
