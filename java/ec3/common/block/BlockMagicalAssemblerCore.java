...
public class BlockMagicalAssemblerCore extends BlockContainer{

	public BlockMagicalAssemblerCore(Material p_i45394_1_) {
		super(p_i45394_1_);
	}
	
	public BlockMagicalAssemblerCore() {
		super(Material.rock);
	}
	...
	public TileEntity createNewTileEntity(World p_149915_1_, int metadata) {
		...
		return new TileMagicalAssembler();
	}
