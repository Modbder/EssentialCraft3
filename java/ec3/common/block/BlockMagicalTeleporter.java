...
public class BlockMagicalTeleporter extends BlockContainer{
	...
	public BlockMagicalTeleporter(Material p_i45394_1_) {
		super(p_i45394_1_);
	}
	
	public BlockMagicalTeleporter() {
		super(Material.rock);
	}
    ...
    {
    	this.renderIcon[1] = p_149651_1_.registerIcon("essentialcraft:magic_telepoter_top");
    	this.renderIcon[0] = p_149651_1_.registerIcon("essentialcraft:magicPlatingBlock");
    }
