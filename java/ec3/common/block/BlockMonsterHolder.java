...
public class BlockMonsterHolder extends BlockContainer{

	public BlockMonsterHolder(Material p_i45394_1_) {
		super(p_i45394_1_);
	}

	public BlockMonsterHolder() {
		super(Material.rock);
	}
