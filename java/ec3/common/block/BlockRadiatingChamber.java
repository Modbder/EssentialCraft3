...
public class BlockRadiatingChamber extends BlockContainer{

	public BlockRadiatingChamber() {
		super(Material.rock);
	}
	
	public BlockRadiatingChamber(Material p_i45394_1_) {
		super(p_i45394_1_);
	}
	...
	public TileEntity createNewTileEntity(World p_149915_1_, int p_149915_2_) {
		...
		return new TileRadiatingChamber();
	}
