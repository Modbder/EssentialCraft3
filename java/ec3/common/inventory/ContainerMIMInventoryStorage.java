...
public class ContainerMIMInventoryStorage extends Container{
	
	TileNewMIMInventoryStorage tile;
    private int chestInventoryRows;
    private int chestInventoryColumns;	

    public ContainerMIMInventoryStorage(InventoryPlayer inventoryPlayer, TileNewMIMInventoryStorage t)
    {
        this.tile = t;
