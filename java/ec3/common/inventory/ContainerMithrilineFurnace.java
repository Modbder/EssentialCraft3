...
public class ContainerMithrilineFurnace extends Container{
	
    private IInventory inv;
    public ContainerMithrilineFurnace(InventoryPlayer par1InventoryPlayer, TileEntity par2)
    {
        this.inv = (IInventory) par2;
        this.addSlotToContainer(new Slot(inv, 0, 80, 64));
        this.addSlotToContainer(new SlotFurnace(par1InventoryPlayer.player, inv, 1, 80, 21));
        int i;
