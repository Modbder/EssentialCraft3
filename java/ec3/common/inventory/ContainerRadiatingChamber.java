...
public class ContainerRadiatingChamber extends Container{
	
    private IInventory inv;
    public ContainerRadiatingChamber(InventoryPlayer par1InventoryPlayer, TileEntity par2)
    {
        this.inv = (IInventory) par2;
        this.addSlotToContainer(new SlotBoundEssence(inv, 0, 155, 5));
        this.addSlotToContainer(new Slot(inv, 1, 108, 5));
        this.addSlotToContainer(new Slot(inv, 2, 108, 41));
        this.addSlotToContainer(new Slot(inv, 3, 126, 23));
        int i;
