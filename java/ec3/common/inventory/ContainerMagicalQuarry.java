...
public class ContainerMagicalQuarry extends Container{
	
    private IInventory inv;
    public ContainerMagicalQuarry(InventoryPlayer par1InventoryPlayer, TileEntity par2)
    {
        this.inv = (IInventory) par2;
        this.addSlotToContainer(new SlotBoundEssence(inv, 0, 108, 23));
        this.addSlotToContainer(new Slot(inv, 1, 108, 41));
        this.addSlotToContainer(new Slot(inv, 2, 126, 41));
        this.addSlotToContainer(new Slot(inv, 3, 144, 41));
        int i;
