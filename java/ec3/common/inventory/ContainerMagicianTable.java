...
public class ContainerMagicianTable extends Container{
	
    private IInventory inv;
    public ContainerMagicianTable(InventoryPlayer par1InventoryPlayer, TileEntity par2)
    {
        this.inv = (IInventory) par2;
        this.addSlotToContainer(new SlotBoundEssence(inv, 0, 153, 5));
        this.addSlotToContainer(new Slot(inv, 1, 44, 23));
        this.addSlotToContainer(new Slot(inv, 2, 26, 5));
        this.addSlotToContainer(new Slot(inv, 3, 62, 5));
        this.addSlotToContainer(new Slot(inv, 4, 26, 41));
        this.addSlotToContainer(new Slot(inv, 5, 62, 41));
        this.addSlotToContainer(new SlotFurnace(par1InventoryPlayer.player, inv, 6, 89, 5));
        int i;
