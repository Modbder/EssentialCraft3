...
public class ContainerCrystalFormer extends Container{
	
    private IInventory inv;
    public ContainerCrystalFormer(InventoryPlayer par1InventoryPlayer, TileEntity par2)
    {
        this.inv = (IInventory) par2;
        this.addSlotToContainer(new SlotBoundEssence(inv, 0, 26, 5));
        this.addSlotToContainer(new Slot(inv, 2, 108, 41));
        this.addSlotToContainer(new Slot(inv, 3, 126, 41));
        this.addSlotToContainer(new Slot(inv, 4, 144, 41));
        this.addSlotToContainer(new Slot(inv, 5, 108, 23));
        this.addSlotToContainer(new Slot(inv, 6, 144, 23));
        this.addSlotToContainer(new Slot(inv, 7, 126, 5));
        this.addSlotToContainer(new Slot(inv, 1, 82, 5));
        int i;
