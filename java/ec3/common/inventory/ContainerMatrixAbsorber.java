...
public class ContainerMatrixAbsorber extends Container{
	
    private IInventory inv;
    public ContainerMatrixAbsorber(InventoryPlayer par1InventoryPlayer, TileEntity par2)
    {
        this.inv = (IInventory) par2;
        this.addSlotToContainer(new Slot(inv, 0, 26, 5));
        int i;
