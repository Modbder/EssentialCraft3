...
public class ContainerFurnaceMagic extends Container{
	
    private IInventory inv;
    public ContainerFurnaceMagic(InventoryPlayer par1InventoryPlayer, TileEntity par2)
    {
        this.inv = (IInventory) par2;
        this.addSlotToContainer(new SlotBoundEssence(inv, 0, 108, 41));
        this.addSlotToContainer(new Slot(inv, 1, 108, 5));
        this.addSlotToContainer(new Slot(inv, 2, 153, 5));
        int i;
