...
public class ContainerMagicalTeleporter extends Container{
	
    private IInventory inv;
    public ContainerMagicalTeleporter(InventoryPlayer par1InventoryPlayer, TileEntity par2)
    {
        this.inv = (IInventory) par2;
        this.addSlotToContainer(new SlotBoundEssence(inv, 0, 108, 23));
        this.addSlotToContainer(new SlotBoundEssence(inv, 1, 140, 23));
        int i;
