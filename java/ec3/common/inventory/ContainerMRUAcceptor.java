...
public class ContainerMRUAcceptor extends Container{
	
    private IInventory tile;
    public ContainerMRUAcceptor(InventoryPlayer par1InventoryPlayer, TileEntity par2)
    {
        this.tile = (IInventory) par2;
        this.addSlotToContainer(new SlotBoundEssence(tile, 0, 80, 32));
        int i;
