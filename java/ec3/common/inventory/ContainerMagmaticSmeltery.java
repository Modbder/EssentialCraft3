...
public class ContainerMagmaticSmeltery extends Container{
	
    private IInventory inv;
    public ContainerMagmaticSmeltery(InventoryPlayer par1InventoryPlayer, TileEntity par2)
    {
        ...
        this.addSlotToContainer(new Slot(inv, 2, 62, 23));
        
        this.addSlotToContainer(new Slot(inv, 3, 126, 5));
        this.addSlotToContainer(new Slot(inv, 4, 126, 23));
        
        this.addSlotToContainer(new Slot(inv, 5, 155, 5));
        this.addSlotToContainer(new Slot(inv, 6, 155, 23));
        
        this.addSlotToContainer(new Slot(inv, 7, 140, 41));
        int i;
