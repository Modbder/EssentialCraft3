...
public class ContainerMagicalJukebox extends Container{
	
    private IInventory inv;
    public ContainerMagicalJukebox(InventoryPlayer par1InventoryPlayer, TileEntity par2)
    {
        this.inv = (IInventory) par2;
        this.addSlotToContainer(new SlotBoundEssence(inv, 0, 108, 23));
        this.addSlotToContainer(new SlotRecord(inv, 1, 26, 5));
        int i;
