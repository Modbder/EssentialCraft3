...
public class ContainerMonsterHarvester extends Container{
	
    private IInventory inv;
    public ContainerMonsterHarvester(InventoryPlayer par1InventoryPlayer, TileEntity par2)
    {
        this.inv = (IInventory) par2;
        this.addSlotToContainer(new SlotBoundEssence(inv, 0, 126, 5));
        this.addSlotToContainer(new Slot(inv, 1, 108, 23));
        this.addSlotToContainer(new Slot(inv, 2, 126, 23));
        this.addSlotToContainer(new Slot(inv, 3, 144, 23));
        this.addSlotToContainer(new Slot(inv, 4, 117, 41));
        this.addSlotToContainer(new Slot(inv, 5, 135, 41));
        int i;
